  ...
  return (
       ...
       <div className='flex md:hidden flex-col justify-center items-center gap-8'>
        ...
        <div className='lg:w-[33vw] md:w-[43vw] w-[85vw] py-5 lg:mt-[14vh] mt-[3vh] h-full'>
            ...
            <div className='text-white text-center md:text-left font-light md:w-[37vw] lg:w-[30vw] text-sm md:text-md lg:text-lg'> I’m Abdullah, a web developer dedicated to creating high-performance websites that are user-friendly and accessible. I specialize in building seamless, responsive interfaces that combine functionality with speed and reliability.</div>
            </div>
            <div className='h-1/2 relative flex justify-center items-start -mt-4 w-full'>
             <button ref={arrowRef} onClick={handleScroll} className="glasst-btn hidden lg:block px-4 mt-[15vh] mr-[2vw] py-4">
                      <span className="text-white  font-bold text-2xl">
                        <IoArrowDown />
                      </span>
                    </button>
            <img src="/images/arrow.png" className='w-[16vw] hidden lg:block md:mt-10 lg:mt-0' alt="arrow" />
            </div>
        </div>
