...
const Footer = ({scrollToSection}) => {
  ...
  <a href="#home"  onClick={() => scrollToSection("home")} className="relative group hover:text-[#85E66C] transition">
    Home
  ...
  <a href="#about" onClick={() => scrollToSection("about")} className="relative group hover:text-[#85E66C] transition">
    About me
    <span className="absolute bottom-[-4px] left-1/2 w-0 h-[1px] bg-[#fff] transition-all duration-300 ease-out group-hover:left-0 group-hover:w-full"></span>
  </a>
  <a href="#work" onClick={() => scrollToSection("work")} className="relative group hover:text-[#85E66C] transition">
    My Work
    <span className="absolute bottom-[-4px] left-1/2 w-0 h-[1px] bg-[#fff] transition-all duration-300 ease-out group-hover:left-0 group-hover:w-full"></span>
  </a>
</div>
        ...
        <div className="text-sm">
          ...
          <div className="flex flex-col opacity-80 leading-6">
            ...
            <p className="mt-1 hover:text-[#85E66C] transition">+92 310 4993978</p>
